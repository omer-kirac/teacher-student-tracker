...
const GooeyNav: React.FC<GooeyNavProps> = ({
  ...
  const makeParticles = (element: HTMLElement) => {
    const d: [number, number] = [minDistance, maxDistance];
    const r = maxRotate;
        ...
        >
          ...
          >
            {items.map((item, index) => (
              <li
                key={index}
                className={`py-[0.6em] px-[1em] rounded-lg relative cursor-pointer transition-[background-color_color_box-shadow] duration-300 ease shadow-[0_0_0.5px_1.5px_transparent] text-white ${
